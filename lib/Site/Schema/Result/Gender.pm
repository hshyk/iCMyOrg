use utf8;
package Site::Schema::Result::Gender;
...
__PACKAGE__->has_many(
  ...
  { "foreign.gender_id" => "self.gender_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07022 @ 2013-05-01 21:28:43
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:b13M1XpyOwhpCIbcZZI2Pg
